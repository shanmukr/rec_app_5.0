...
function addInterviewRow(existing_interview_num, req_match_id, row_index, emp_ids, emp_names, time_array)
{
  ...
  if ( total_interview_num < 5 )
  {
    ...
    element3.src  = prepend_with_image_path + "/assets/calendar_date_select/calendar.gif";
...
function markJoining(event, match_id, resume_id)
{
  event.preventDefault();
...
function getJoiningDateBox(div_element)
{
  ...
  image_element.src  = prepend_with_image_path + "/assets/calendar_date_select/calendar.gif";
...
function deleteAjaxRequestTr(event, element)
{
  event.preventDefault();
  $(element).remove();
...
function showHide(elem)
{
  ...
  {
    elem.src            = prepend_with_image_path + "/assets/minusIcon.gif";
    table.style.display = '';
  }
  else
  {
    elem.src = prepend_with_image_path + "/assets/plusIcon.gif";
...
function openResumeInNewTab(resume_uniqid) {
  window.open ( prepend_with_image_path + "/resumes/" + resume_uniqid);
  return false;
}
...
function get_image_name(likely_to_join) {
  ...
  return prepend_with_image_path + '/assets/' + img_name + '_Image.png';
}
